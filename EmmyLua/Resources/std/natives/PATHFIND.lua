...
--- bool p7 - always 1  
--- ```
--- #### Category: [PATHFIND](https://docs.fivem.net/natives/?n_PATHFIND)
...
--- ```
--- #### Category: [PATHFIND](https://docs.fivem.net/natives/?n_PATHFIND)
---@overload fun(coords:vector3, y:number, z:number):boolean,vector3,number
---@param x number 
---@param y number 
---@param z number 
...
--- ```
--- #### Category: [PATHFIND](https://docs.fivem.net/natives/?n_PATHFIND)
---@overload fun(coords:vector3, y:number):boolean,vector3
---@param x number 
---@param y number 
---@param z number 
...
---@param p5 any 
---@param p6 any 
function _0xAA76052DDA9BFC3E(p0, p1, p2, p3, p4, p5, p6) end
...
--- ```
--- #### Category: [PATHFIND](https://docs.fivem.net/natives/?n_PATHFIND)
---@overload fun(coords:vector3, y:number, z:number):boolean,vector3
---@param x number 
---@param y number 
---@param z number 
---@param nodeType number 
...
--- ```
--- #### Category: [PATHFIND](https://docs.fivem.net/natives/?n_PATHFIND)
---@overload fun(coords:vector3, y:number, z:number, width:number, length:number, height:number):any
...
--- #### Category: [PATHFIND](https://docs.fivem.net/natives/?n_PATHFIND)
---@overload fun(coords:vector3, y:number, z:number, nthClosest:number):boolean,vector3
---@param x number 
---@param y number 
---@param z number 
...
--- #### Category: [PATHFIND](https://docs.fivem.net/natives/?n_PATHFIND)
---@overload fun(coords:vector3, y:number, z:number, nthClosest:number):number,vector3,number
---@param x number 
---@param y number 
---@param z number 
---@param nthClosest number 
...
--- ```
--- #### Category: [PATHFIND](https://docs.fivem.net/natives/?n_PATHFIND)
---@overload fun(coords:vector3, y:number, z:number):any,vector3,vector3,any,any,number
---@param x number 
---@param y number 
---@param z number 
---@param p3 number 
...
--- #### Category: [PATHFIND](https://docs.fivem.net/natives/?n_PATHFIND)
---@overload fun(coords:vector3, y:number, z:number, radius:number):boolean,vector3,number
---@param x number 
---@param y number 
---@param z number 
---@param radius number 
...
--- ```
--- #### Category: [PATHFIND](https://docs.fivem.net/natives/?n_PATHFIND)
---@overload fun(coords:vector3, y:number, z:number, desiredX:number, desiredY:number, desiredZ:number, nthClosest:number):boolean,vector3,number
---@param x number 
---@param y number 
---@param z number 
...
--- ```
--- #### Category: [PATHFIND](https://docs.fivem.net/natives/?n_PATHFIND)
---@overload fun(coords:vector3, y:number, z:number, nthClosest:number):boolean,vector3,number,any
---@param x number 
---@param y number 
---@param z number 
---@param nthClosest number 
...
---@param y number 
---@param z number 
---@param streetName number 
---@param crossingRoad number 
...
--- ```
--- #### Category: [PATHFIND](https://docs.fivem.net/natives/?n_PATHFIND)
---@overload fun(coords:vector3):number,number,number,number
---@param x number 
---@param y number 
---@param z number 
---@param p3 boolean 
...
--- ```
--- #### Category: [PATHFIND](https://docs.fivem.net/natives/?n_PATHFIND)
---@overload fun(coords:vector3, y:number, z:number, nth:number):number
---@param x number 
---@param y number 
---@param z number 
---@param nth number 
